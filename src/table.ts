...
import { DeletedRecords } from "./deleted_records";
declare type TableError = any;
declare type CreateRecord<TFields> = Pick<
  RecordData<Partial<TFields>>,
  "fields"
>;
declare type CreateRecords<TFields> =
  | string[]
  | Partial<TFields>[]
...
declare type RecordCollectionCallback<TFields extends FieldSet> = (
  error: TableError,
  records?: Records<TFields>
) => void;
declare type RecordDeletedCollectionCallback<TFields extends FieldSet> = (
  error: TableError,
  records?: DeletedRecords<TFields>
) => void;
declare type RecordCallback<TFields extends FieldSet> = (
  error: TableError,
  record?: Record<TFields>
) => void;
declare type RecordDeletedCallback<TFields extends FieldSet> = (
  error: TableError,
  record?: DeletedRecord<TFields>
) => void;
declare type RecordListCallback<TFields extends FieldSet> = (
  error: TableError,
  records?: Records<TFields>,
  offset?: number
) => void;
declare type RecordForEachCallback<TFields extends FieldSet> = (
  record: Record<TFields>
) => void;
...
interface TableCreateRecords<TFields extends FieldSet> {
  (
    recordsData: CreateRecords<TFields["Write"]>,
  ...
  (
    recordData: string | Partial<TFields["Write"]>,
    optionalParameters?: OptionalParameters
...
interface TableChangeRecords<TFields extends FieldSet> {
  (
    recordId: string,
    recordData: Partial<TFields["Write"]>,
  ...
  (
    recordsData: RecordData<Partial<TFields["Write"]>>[],
    opts?: OptionalParameters
  ): Promise<Records<TFields>>;
  (
    recordsData: RecordData<Partial<TFields["Write"]>>[],
...
interface TableDestroyRecords<TFields extends FieldSet> {
  (recordId: string): Promise<DeletedRecord<TFields>>;
  (recordId: string, done: RecordDeletedCallback<TFields>): void;
  (recordIds: string[]): Promise<DeletedRecords<TFields>>;
  (recordIds: string[], done: RecordDeletedCollectionCallback<TFields>): void;
}
